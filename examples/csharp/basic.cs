...
{
    class JSONtoCSVConverterExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/jsontocsv";

        /// <summary>
        /// Make a POST request to the JSON to CSV Converter API
        /// </summary>
        static async Task<JsonDocument> CallJSONtoCSVConverterAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { json &#x3D; [object Object],[object Object], delimiter &#x3D; &quot;,&quot;, include_header &#x3D; true };
        ...
        {
            Console.WriteLine("📤 Calling JSON to CSV Converter API...\n");

            var result = await CallJSONtoCSVConverterAPI();
