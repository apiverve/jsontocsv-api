// Package jsontocsv provides a Go client for the JSON to CSV Converter API.
//
// For more information, visit: https://apiverve.com/marketplace/jsontocsv?utm_source=go&utm_medium=readme
package jsontocsv
...
// Request contains the parameters for the JSON to CSV Converter API.
//
// Parameters:
//   - json (required): array - The JSON array to convert to CSV (must be array of objects)
//   - delimiter: string - The delimiter to use in the CSV
//   - include_header: boolean - Whether to include column headers in the output (default: true)
type Request struct {
	Json []map[string]interface{} `json:"json"` // Required
	Delimiter string `json:"delimiter,omitempty"` // Optional
	IncludeHeader bool `json:"include_header,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"include_header": {Type: "boolean", Required: false},
	}
...
// ResponseData contains the data returned by the JSON to CSV Converter API.
