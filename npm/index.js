...
class jsontocsvWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/jsontocsv');
        }
        ...
        this.validationRules = {"json":{"type":"array","required":true},"delimiter":{"type":"string","required":false,"default":","},"include_header":{"type":"boolean","required":false,"default":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/jsontocsv`);
        }
    }
...
module.exports = jsontocsvWrapper;
