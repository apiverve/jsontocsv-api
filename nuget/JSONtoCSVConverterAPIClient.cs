...
namespace APIVerve.API.JSONtoCSVConverter
{
    ...
    /// <summary>
    /// Client for the JSONtoCSVConverter API
    /// </summary>
    public class JSONtoCSVConverterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/jsontocsv";
        ...
        {
            { "json", new ValidationRule { Type = "array", Required = true } },
            { "delimiter", new ValidationRule { Type = "string", Required = false } },
            { "include_header", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public JSONtoCSVConverterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public JSONtoCSVConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public JSONtoCSVConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, JSONtoCSVConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(JSONtoCSVConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(JSONtoCSVConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(JSONtoCSVConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(JSONtoCSVConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(JSONtoCSVConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(JSONtoCSVConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(JSONtoCSVConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(JSONtoCSVConverterQueryOptions options)
        {
