...
/**
 * Client for the JSON to CSV Converter API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/jsontocsv?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/jsontocsv';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\JsontocsvClient] {$message}\n";
        }
    }
}
